...
1. The following pattern is discouraged in favor of [the Redlock algorithm](https://server.io/topics/distlock) which is only a bit more complex to implement, but offers better guarantees and is fault tolerant.
