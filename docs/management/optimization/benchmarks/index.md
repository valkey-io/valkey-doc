...
You can even benchmark a specific command:
    ...
    $ valkey-benchmark -n 100000 -q script load "valkey.call('set','foo','bar')"
    script load valkey.call('set','foo','bar'): 69881.20 requests per second
...
[thread](https://groups.google.com/forum/#!msg/valkey-db/gUhc19gnYgc/BruTPCOroiMJ).
