...
You can learn more about access control, data protection and encryption, secure Valkey architectures, and secure deployment techniques by taking the [Valkey University security course](https://university.valkey.com/courses/ru330/).
...
internet with public IPs. Since version 3.2.0, Valkey enters a special mode called **protected mode** when it is
...
The recommended authentication method, introduced in Valkey 6, is via Access Control Lists, allowing named users to be created and assigned fine-grained permissions.
