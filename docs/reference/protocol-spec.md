...
In Valkey 2.0, the protocol's next version, a.k.a RESP2, became the standard communication method for clients with the Valkey server.
...
Valkey 6.0 introduced experimental opt-in support of RESP3's features (excluding streaming strings and streaming aggregates).
...
Up to and including Valkey 7, both RESP2 and RESP3 clients can invoke all core commands.
