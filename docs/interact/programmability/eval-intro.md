...
Starting with Redis OSS 3.2, Redis has support for native Lua debugging.
...
However, starting with Redis OSS 7.0, there's a way to declare flags when creating a script in order to tell Redis how it should behave.
